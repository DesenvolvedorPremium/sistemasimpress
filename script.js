...
// Banco de dados simulado (substitua pelo seu real)
const database = {
  oldPrinters: [],
  newPrinters: [],
  replacements: [],
  buildings: ['Bloco J', 'Bloco K', 'Bloco C', 'Bloco F Sede', 'Bloco P Sede', 'Bloco F Anexo', 'Bloco P Anexo']
};

// Função para carregar dados de exemplo (remova quando conectar ao banco real)
function loadSampleData() {
  database.oldPrinters = [
    {
      serial: "ABC123",
  ...
  database.newPrinters = [
    {
      serial: "XYZ789",
      model: "HP Neverstop 1200w",
      online: true,
      bloco: "Bloco K",
      andar: "1",
      sala: "101",
...
// Função para configurar a navegação (corrigida)
function setupNavigation() {
    ...
    // Ativa a página inicial (dashboard)
    const defaultPage = document.querySelector('.menu-item[data-page="dashboard"]');
    if (defaultPage) {
        defaultPage.click(); // Simula um clique para ativar a página inicial
    }
}
